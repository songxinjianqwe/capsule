...
// ProcessStat represents the information from /proc/[pid]/stat, as
...
// GetProcessStat returns a ProcessStat instance for the specified process.
func GetProcessStat(pid int) (stat ProcessStat, err error) {
...
func parseStat(data string) (stat ProcessStat, err error) {
